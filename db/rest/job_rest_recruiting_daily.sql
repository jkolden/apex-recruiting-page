...
BEGIN
    DBMS_SCHEDULER.CREATE_JOB(
        ...
        job_action      => 'BEGIN apex_session.create_session(p_app_id=>121,p_page_id=>1,p_username=>''ADMIN''); pkg_rest_recruiting.refresh_all(p_full_refresh => true); apex_session.delete_session; END;',
