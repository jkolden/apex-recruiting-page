-- =============================================================================
-- LANDING TABLE: LANDING_QSTNR_RESPONSE
-- =============================================================================
...
-- The load procedure then cherry-picks columns into STG_FBX_QSTNR_RESPONSE.
--
-- SETUP (three steps):
...
--   DROP TABLE LANDING_QSTNR_RESPONSE;
--   DROP TABLE EXT_BICC_QSTNR_RESPONSE;
...
BEGIN
  DBMS_CLOUD.CREATE_EXTERNAL_TABLE(
    table_name      => 'EXT_BICC_QSTNR_RESPONSE',
    credential_name => 'OBJ_STORE_CRED_JK',
    file_uri_list   => 'https://objectstorage.us-ashburn-1.oraclecloud.com/n/idlhcuqzdx2c/b/SCI_Conversion/o/staging/qstnr_response_current.csv',
    format          => json_object(
                         'type' value 'csv',
                         'skipheaders' value '1'
                       ),
...
CREATE TABLE LANDING_QSTNR_RESPONSE AS SELECT * FROM EXT_BICC_QSTNR_RESPONSE WHERE 1=0;
