 ...
 * ----------------------------
 * Opens a modal listing attachments for a job application,
 * fetched via REST from Fusion (pkg_app_attachments).
 *
 * APEX setup:
 *   - Upload as Static Application File, reference on page 24:
 *       JS File URL:  #APP_FILES#attachments_js#MIN#.js
 *   - Requires Ajax callback: LIST_ATTACHMENTS
 *   - IR column calls openAttachments(JOB_APPLICATION_ID)
 */
(function () {
    "use strict";

    /* ── Open modal ── */
    window.openAttachments = function (appId) {
    ...
    /* ── Close modal ── */
    window.closeAttachments = function () {
